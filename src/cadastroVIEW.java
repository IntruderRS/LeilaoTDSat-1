...
public class cadastroVIEW extends javax.swing.JFrame {
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        try {
            ...
            //Converter o valor (aceitando ponto ou vírgula)
            ...
            // Mensagem se o usuário digitar letras no campo de valor
            javax.swing.JOptionPane.showMessageDialog(null, "Erro: O campo 'Valor' deve conter apenas números.");
        }
